...
if __name__ == "__main__" and __package__ is None:
    ...
    # 参考 PEP 366 https://www.python.org/dev/peps/pep-0366/
    # 指定了 __package__,所有的相对路径的 import 都是以此为当前目录, 而不是 __name__
...
def get_session():
    ...
    # 参见 https://www.tensorflow.org/guide/using_gpu, 不限制对 GPU 内存的使用
...
def parse_args(args):
    ...
    parser.add_argument('--backbone_name', help='Name of backbone model used by retinanet.', default='resnet50',
                        type=str)
...
def main(args=None):
    ...
    backbone = models.backbone(args.backbone_name)
